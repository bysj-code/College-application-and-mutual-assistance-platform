<template>
	<view class="diy_details diy_div_dormitory_repair_report">
		<view v-if="Object.keys(obj).length!==0" class="warp">
			<view class="container">
				<view class="row">
					...
					<view v-if="$check_field('get','dormitory_number')" class="col-12 col-md-6">
						<view class="diy_title">
							<span>宿舍号:</span>
						</view>
							<view class="diy_field diy_text">
							<text>
								{{obj["dormitory_number"]}}
							</text>
						</view>
						</view>
...
<script>
	...
	export default {
		...
		methods: {
			...
			async get_obj_by_id(){
				var res = await this.$get("~/api/dormitory_repair_report/get_obj", {
					dormitory_repair_report_id:this.query.dormitory_repair_report_id
				})
		...
		async onLoad(){
			...
			} else if (this.query["dormitory_repair_report_id"] !==0) {
...
<style scoped>
	.div_dormitory_repair_report_details {}
