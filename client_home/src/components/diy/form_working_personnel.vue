<template>
	<div>
			<view v-if="$check_register_field('add','job_id','/working_personnel/view')" class="col-12 col-md-6">
			<view class="diy_title">
				...
				<view class="diy_field diy_text">
					<input type="text" id="form_job_id" v-model="form['job_id']" @blur="handleBlur($event.target.value,'job_id')"  placeholder="请输入工号" />
				</view>
							</view>
				<view v-if="$check_register_field('add','full_name','/working_personnel/view')" class="col-12 col-md-6">
			<view class="diy_title">
				<text>
					姓名:
				</text>
				...
				<view v-if="$check_register_field('add','gender','/working_personnel/view')" class="col-12 col-md-6">
			<view class="diy_title">
				<text>
					性别:
				</text>
