<template>
	<view class="diy_details diy_div_outdoor_repair_report">
...
<script>
	...
	export default {
		...
		methods: {
			...
			async get_obj_by_id(){
				var res = await this.$get("~/api/outdoor_repair_report/get_obj", {
					outdoor_repair_report_id:this.query.outdoor_repair_report_id
				})
		...
		async onLoad(){
			...
			} else if (this.query["outdoor_repair_report_id"] !==0) {
...
<style scoped>
	.div_outdoor_repair_report_details {}
