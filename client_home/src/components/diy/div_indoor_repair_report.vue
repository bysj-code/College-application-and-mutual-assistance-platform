<template>
	<view class="diy_details diy_div_indoor_repair_report">
		<view v-if="Object.keys(obj).length!==0" class="warp">
			<view class="container">
				<view class="row">
					...
					<view v-if="$check_field('get','select_region')" class="col-12 col-md-6">
						<view class="diy_title">
							<span>选择区域:</span>
						</view>
							<view class="diy_field diy_text">
					...
					<view v-if="$check_field('get','specific_location')" class="col-12 col-md-6">
						<view class="diy_title">
							<span>具体位置:</span>
						</view>
							<view class="diy_field diy_text">
...
<script>
	...
	export default {
		...
		methods: {
			...
			async get_obj_by_id(){
				var res = await this.$get("~/api/indoor_repair_report/get_obj", {
					indoor_repair_report_id:this.query.indoor_repair_report_id
				})
		...
		async onLoad(){
			...
			} else if (this.query["indoor_repair_report_id"] !==0) {
...
<style scoped>
	.div_indoor_repair_report_details {}
