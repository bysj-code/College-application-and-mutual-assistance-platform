	...
	<div>
			...
			<view class="diy_title">
				...
				<view class="diy_field diy_text">
					<input type="text" id="form_student_id" v-model="form['student_id']" @blur="handleBlur($event.target.value,'student_id')"  placeholder="请输入学号" />
				</view>
							</view>
				<view v-if="$check_register_field('add','full_name','/student_users/view')" class="col-12 col-md-6">
			<view class="diy_title">
				<text>
					姓名:
				</text>
			...
			<view class="diy_field diy_down">
				...
				<view v-if="$check_register_field('add','dormitory_number','/student_users/view')" class="col-12 col-md-6">
			<view class="diy_title">
				<text>
					宿舍号:
				</text>
									...
									<!-- 文本 -->
				<view class="diy_field diy_text">
					<input type="text" id="form_dormitory_number" v-model="form['dormitory_number']" @blur="handleBlur($event.target.value,'dormitory_number')"  placeholder="请输入宿舍号" />
				</view>
							</view>
		</div>
</template>
