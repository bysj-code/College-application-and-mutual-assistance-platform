<template>
  <view class="page_working_personnel diy_table diy_table_tml" id="working_personnel_table">
    <!-- 筛选模块(开始) -->
    <view>
          ...
          <view>
            <view class="">
              ...
              <uni-forms :modelValue="query">
                  <uni-forms-item label="工号" name="job_id">
                      <uni-easyinput type="text" v-model="query.job_id" placeholder="工号" />
                    </uni-forms-item>
                    </uni-forms>
              <!-- /搜索栏 -->
        ...
        <view>
          <view>
            <view class="table_padding_top">
              <navigator class="nav_left" url="/pages/working_personnel/view?" v-show="user_group == '管理员' || $check_action('/working_personnel/table','add') || $check_action('/working_personnel/view','add')">添加</navigator>
		...
		<view class="warp">
			<view class="container">
				<view v-for="(o,i) in list" class="row">
										<view v-if="0 && $check_field('get','job_id')" class="col">
						<view class="view">
                  ...
                  <view class="col">
                    <view class="view">
                      <view class="create_time_block diy_filed diy_time">
                        ...
                        <button class="delete_a_btn" @click="delInfo(i)" v-show="user_group == '管理员' || $check_action('/working_personnel/table','del') || $check_action('/working_personnel/view','del')">删除</button>
                      </view>
                    </view>
                  </view>
					<view class="uni-padding-wrap uni-common-mt">
					<navigator  :url="'/pages/working_personnel/view?' + field + '=' + o[field]"
                               v-show="user_group == '管理员' || $check_action('/working_personnel/table','set') || $check_action('/working_personnel/view','set') || $check_action('/working_personnel/view','get')" class="btn btn-primary">详情</navigator>
	        					</view>
				</view>
			</view>
		</view>
