<template>
	<view class="page_campus_articles diy_list diy_list_page div_list_tml" id="campus_articles_list">
		<!-- 筛选模块(开始) -->
		<view>
			...
			<view class="container">
				<view v-for="(o,i) in list" class="row box_style">
					...
					<view class="uni-padding-wrap uni-common-mt">
						<navigator :url="'./details?campus_articles_id=' + o['campus_articles_id']" class="btn btn-primary">查看详情</navigator>
...
<script>
	 ...
	 */
	get_praise(list){
		this.$get("~/api/praise/count_group?groupby=source_id&source_table=campus_articles", {}, (res) => {
			if(res.result){
				res.result.map((o)=>{
					for(var i = 0;i < list.length; i++){
						var oj = list[i];
						if(oj["campus_articles_id"] === o["source_id"]){
	 ...
	 */
	to_nav(id) {
		this.$nav('/pages/campus_articles/details?campus_articles_id=' + id)
	},
