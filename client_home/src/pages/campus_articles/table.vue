<template>
  <view class="page_campus_articles diy_table diy_table_tml" id="campus_articles_table">
    <!-- 筛选模块(开始) -->
    <view>
        ...
        <view>
          <view>
            <view class="table_padding_top">
              <navigator class="nav_left" url="/pages/campus_articles/view?" v-show="user_group == '管理员' || $check_action('/campus_articles/table','add') || $check_action('/campus_articles/view','add')">添加</navigator>
						...
						<view class="view">
							<view class="diy_title" v-if=" false">
								<span>文章封面</span>
									...
									<view class="col" v-if="0 && $check_field('get','publish_users')">
						<view class="view">
							<view class="diy_title" v-if="true">
								<span>发布用户</span>
							</view>
				...
				<view class="col">
					<view class="view">
						<view class="create_time_block diy_filed diy_time">
                          ...
                          <button class="delete_a_btn" @click="delInfo(i)" v-show="user_group == '管理员' || $check_action('/campus_articles/table','del') || $check_action('/campus_articles/view','del')">删除</button>
                        </view>
					</view>
				</view>
				<view class="uni-padding-wrap uni-common-mt">
					<navigator  :url="'/pages/campus_articles/view?' + field + '=' + o[field]"
						v-show="user_group == '管理员' || $check_action('/campus_articles/table','set') || $check_action('/campus_articles/view','set') || $check_action('/campus_articles/view','get')" class="btn btn-primary">详情</navigator>
					                    									</view>
			</view>
		</view>
	</view>
