<template>
  <view class="page_student_users diy_table diy_table_tml" id="student_users_table">
    <!-- 筛选模块(开始) -->
    <view>
            ...
            <view class="">
              ...
              <uni-forms :modelValue="query">
                  <uni-forms-item label="学号" name="student_id">
                      <uni-easyinput type="text" v-model="query.student_id" placeholder="学号" />
                    </uni-forms-item>
                      </uni-forms>
              <!-- /搜索栏 -->
        ...
        <view>
          <view>
            <view class="table_padding_top">
              <navigator class="nav_left" url="/pages/student_users/view?" v-show="user_group == '管理员' || $check_action('/student_users/table','add') || $check_action('/student_users/view','add')">添加</navigator>
		...
		<view class="warp">
			<view class="container">
				<view v-for="(o,i) in list" class="row">
										<view v-if="0 && $check_field('get','student_id')" class="col">
						<view class="view">
                            ...
                            <span>性别</span>
								...
								<text>
									{{ o["gender"] }}
													...
													<view v-if="0 && $check_field('get','dormitory_number')" class="col">
						<view class="view">
                          <view class="diy_title" v-if="true">
                            <span>宿舍号</span>
                          </view>
                  ...
                  <view class="col">
                    <view class="view">
                      <view class="create_time_block diy_filed diy_time">
                        ...
                        <button class="delete_a_btn" @click="delInfo(i)" v-show="user_group == '管理员' || $check_action('/student_users/table','del') || $check_action('/student_users/view','del')">删除</button>
                      </view>
                    </view>
                  </view>
					<view class="uni-padding-wrap uni-common-mt">
					<navigator  :url="'/pages/student_users/view?' + field + '=' + o[field]"
                               v-show="user_group == '管理员' || $check_action('/student_users/table','set') || $check_action('/student_users/view','set') || $check_action('/student_users/view','get')" class="btn btn-primary">详情</navigator>
	        					</view>
				</view>
			</view>
		</view>
