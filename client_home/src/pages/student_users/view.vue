          ...
          <view class="">
            <uni-forms :modelValue="form"  v-if="is_view()">
              ...
              <uni-forms-item v-if="$check_field('get','student_id') || ($check_field('add','student_id') || $check_field('set','student_id'))" label="学号" name="student_id">
                            <uni-easyinput type="text" v-model="form['student_id']" v-if="user_group === '管理员' || (form['student_users_id'] && $check_field('set','student_id')) || (!form['student_users_id'] && $check_field('add','student_id'))" :disabled="disabledObj['student_id_isDisabled']" />
                <!-- 仅查看 -->
              ...
              <uni-forms-item v-if="$check_field('get','full_name') || ($check_field('add','full_name') || $check_field('set','full_name'))" label="姓名" name="full_name">
                            <uni-easyinput type="text" v-model="form['full_name']" v-if="user_group === '管理员' || (form['student_users_id'] && $check_field('set','full_name')) || (!form['student_users_id'] && $check_field('add','full_name'))" :disabled="disabledObj['full_name_isDisabled']" />
                <!-- 仅查看 -->
              ...
              <uni-forms-item v-if="$check_field('get','gender') || ($check_field('add','gender') || $check_field('set','gender'))" label="性别" name="gender">
                  ...
                  v-if="user_group === '管理员' || (form['student_users_id'] && $check_field('set','gender')) || (!form['student_users_id'] && $check_field('add','gender'))"
                ></uni-data-select>
                <!-- 仅查看 -->
              ...
              <uni-forms-item v-if="$check_field('get','dormitory_number') || ($check_field('add','dormitory_number') || $check_field('set','dormitory_number'))" label="宿舍号" name="dormitory_number">
                            <uni-easyinput type="text" v-model="form['dormitory_number']" v-if="user_group === '管理员' || (form['student_users_id'] && $check_field('set','dormitory_number')) || (!form['student_users_id'] && $check_field('add','dormitory_number'))" :disabled="disabledObj['dormitory_number_isDisabled']" />
                <!-- 仅查看 -->
...
export default {
  ...
  data() {
    return {
      ...
      is_password: true,
      field: "student_users_id",
      url_add: "~/api/student_users/add?",
      url_set: "~/api/student_users/set?",
      url_get_obj: "~/api/student_users/get_obj?",
