          ...
          <view class="">
            <uni-forms :modelValue="form"  v-if="is_view()">
              ...
              <uni-forms-item v-if="$check_field('get','repair_user') || ($check_field('add','repair_user') || $check_field('set','repair_user'))" label="报修用户" name="repair_user">
                  ...
                  v-if="user_group === '管理员' || (form['outdoor_repair_report_id'] && $check_field('set','repair_user')) || (!form['outdoor_repair_report_id'] && $check_field('add','repair_user'))"
                ></uni-data-select>
                <uni-data-select
                  v-model="form['repair_user']"
                  :localdata="list_user_repair_user"
              ...
              <uni-forms-item v-if="$check_field('get','full_name') || ($check_field('add','full_name') || $check_field('set','full_name'))" label="姓名" name="full_name">
                            <uni-easyinput type="text" v-model="form['full_name']" v-if="user_group === '管理员' || (form['outdoor_repair_report_id'] && $check_field('set','full_name')) || (!form['outdoor_repair_report_id'] && $check_field('add','full_name'))" :disabled="disabledObj['full_name_isDisabled']" />
                <!-- 仅查看 -->
              ...
              <uni-forms-item v-if="$check_field('get','repair_date') || ($check_field('add','repair_date') || $check_field('set','repair_date'))" label="报修日期" name="repair_date">
                    <uni-datetime-picker v-if="user_group === '管理员' || (form['outdoor_repair_report_id'] && $check_field('set','repair_date')) || (!form['outdoor_repair_report_id'] && $check_field('add','repair_date'))" v-model="form['repair_date']" type="date" :disabled="disabledObj['repair_date_isDisabled']" />
                <!-- 仅查看 -->
              ...
              <uni-forms-item v-if="$check_field('get','repair_content') || ($check_field('add','repair_content') || $check_field('set','repair_content'))" label="报修内容" name="repair_content">
                            <uni-easyinput type="text" v-model="form['repair_content']" v-if="user_group === '管理员' || (form['outdoor_repair_report_id'] && $check_field('set','repair_content')) || (!form['outdoor_repair_report_id'] && $check_field('add','repair_content'))" :disabled="disabledObj['repair_content_isDisabled']" />
                <!-- 仅查看 -->
              ...
              <uni-forms-item v-if="$check_field('get','maintenance_records') || ($check_field('add','maintenance_records') || $check_field('set','maintenance_records'))" label="维修记录" name="maintenance_records">
                            <uni-easyinput type="text" v-model="form['maintenance_records']" v-if="user_group === '管理员' || (form['outdoor_repair_report_id'] && $check_field('set','maintenance_records')) || (!form['outdoor_repair_report_id'] && $check_field('add','maintenance_records'))" :disabled="disabledObj['maintenance_records_isDisabled']" />
                <!-- 仅查看 -->
              ...
              <uni-forms-item v-if="$check_field('get','repair_personnel') || ($check_field('add','repair_personnel') || $check_field('set','repair_personnel'))" label="维修人员" name="repair_personnel">
                  ...
                  v-if="user_group === '管理员' || (form['outdoor_repair_report_id'] && $check_field('set','repair_personnel')) || (!form['outdoor_repair_report_id'] && $check_field('add','repair_personnel'))"
                ></uni-data-select>
                <uni-data-select
                  v-model="form['repair_personnel']"
                  :localdata="list_user_repair_personnel"
      ...
      uni.chooseFile({
        ...
        success: function(res) {
          ...
          const uploadTask = uni.uploadFile({
            url: _self.$fullUrl('/api/outdoor_repair_report/upload?'),
