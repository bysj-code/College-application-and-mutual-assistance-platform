<template>
  <view class="page_outdoor_repair_report diy_table diy_table_tml" id="outdoor_repair_report_table">
    <!-- 筛选模块(开始) -->
    <view>
        ...
        <view>
          <view>
            <view class="table_padding_top">
              <navigator class="nav_left" url="/pages/outdoor_repair_report/view?" v-show="user_group == '管理员' || $check_action('/outdoor_repair_report/table','add') || $check_action('/outdoor_repair_report/view','add')">添加</navigator>
                  ...
                  <view class="col">
                    <view class="view">
                      <view class="create_time_block diy_filed diy_time">
                        ...
                        <button class="delete_a_btn" @click="delInfo(i)" v-show="user_group == '管理员' || $check_action('/outdoor_repair_report/table','del') || $check_action('/outdoor_repair_report/view','del')">删除</button>
                      </view>
                    </view>
                  </view>
					<view class="uni-padding-wrap uni-common-mt">
					<navigator  :url="'/pages/outdoor_repair_report/view?' + field + '=' + o[field]"
                               v-show="user_group == '管理员' || $check_action('/outdoor_repair_report/table','set') || $check_action('/outdoor_repair_report/view','set') || $check_action('/outdoor_repair_report/view','get')" class="btn btn-primary">详情</navigator>
	        					</view>
				</view>
			</view>
		</view>
