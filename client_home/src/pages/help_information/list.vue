<template>
	<view class="page_help_information diy_list diy_list_page div_list_tml" id="help_information_list">
		<!-- 筛选模块(开始) -->
		<view>
			<view class="container">
				<view>
					<view>
						<view class="">
							<!-- 搜索栏 -->
													<uni-search-bar placeholder="搜索求助标题" @confirm="search" @cancel="cancel" cancelText="取消"
											@input="input($event, 'help_title')">
								<uni-icons slot="searchIcon" color="#999999" size="18" type="home" />
							</uni-search-bar>
																			<uni-search-bar placeholder="搜索求助类型" @confirm="search" @cancel="cancel" cancelText="取消"
											@input="input($event, 'type_of_help_sought')">
								<uni-icons slot="searchIcon" color="#999999" size="18" type="home" />
							</uni-search-bar>
																	<!-- /搜索栏 -->
						</view>
			...
			<view class="container">
				<view v-for="(o,i) in list" class="row">
					...
					<view class="uni-padding-wrap uni-common-mt">
						<navigator class="btn btn-primary" :url="'./details?help_information_id=' + o['help_information_id']">查看详情</navigator>
					</view>
				</view>
			</view>
		</view>
