<template>
	<view class="page_help_information diy_detail diy_detail--new" id="help_information_details">
		<view class="warp">
			<view class="container-fluid">
				<view class="row">
					<view v-if="$check_field('get','help_title')" class="col-12 col-6">
						<view class="view">
					...
					<view v-if="$check_field('get','type_of_help_sought')" class="col-12 col-6">
						<view class="view">
							<view class="diy_title">
								<span>求助类型</span>
							</view>
					...
					<view v-if="$check_field('get','date_of_assistance')" class="col-12 col-6">
						<view class="view">
							<view class="diy_title">
								<span>求助日期</span>
							</view>
					...
					<view v-if="$check_field('get','help_content')" class="col-12 col-6">
						<view class="view">
							<view class="diy_title">
								<span>求助内容</span>
							</view>
...
<!--						<button type="button" class="btn btn-primary" @click="cancel()">返回</button>-->
						...
						<navigator class="btn link"
							:url="'/pages/comment/edit?source_table=help_information&source_field=help_information_id&source_id=' + obj['help_information_id']">
							评论
						</navigator>
		...
		methods: {
			...
			get_comment(obj) {
				this.$get("~/api/comment/get_list?", {
					source_table: "help_information",
					source_field: "help_information_id",
					source_id: obj["help_information_id"]
				}, (res) => {
