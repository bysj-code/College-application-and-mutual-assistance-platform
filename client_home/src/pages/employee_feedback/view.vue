          ...
          <view class="">
            <uni-forms :modelValue="form"  v-if="is_view()">
              ...
              <uni-forms-item v-if="$check_field('get','feedback_to_users') || ($check_field('add','feedback_to_users') || $check_field('set','feedback_to_users'))" label="反馈用户" name="feedback_to_users">
                  ...
                  v-if="user_group === '管理员' || (form['employee_feedback_id'] && $check_field('set','feedback_to_users')) || (!form['employee_feedback_id'] && $check_field('add','feedback_to_users'))"
                ></uni-data-select>
                <uni-data-select
                  v-model="form['feedback_to_users']"
                  :localdata="list_user_feedback_to_users"
              ...
              <uni-forms-item v-if="$check_field('get','full_name') || ($check_field('add','full_name') || $check_field('set','full_name'))" label="姓名" name="full_name">
                            <uni-easyinput type="text" v-model="form['full_name']" v-if="user_group === '管理员' || (form['employee_feedback_id'] && $check_field('set','full_name')) || (!form['employee_feedback_id'] && $check_field('add','full_name'))" :disabled="disabledObj['full_name_isDisabled']" />
                <!-- 仅查看 -->
              ...
              <uni-forms-item v-if="$check_field('get','feedback_date') || ($check_field('add','feedback_date') || $check_field('set','feedback_date'))" label="反馈日期" name="feedback_date">
                    <uni-datetime-picker v-if="user_group === '管理员' || (form['employee_feedback_id'] && $check_field('set','feedback_date')) || (!form['employee_feedback_id'] && $check_field('add','feedback_date'))" v-model="form['feedback_date']" type="date" :disabled="disabledObj['feedback_date_isDisabled']" />
                <!-- 仅查看 -->
              ...
              <uni-forms-item v-if="$check_field('get','feedback_content') || ($check_field('add','feedback_content') || $check_field('set','feedback_content'))" label="反馈内容" name="feedback_content">
                    <uni-easyinput type="textarea" v-model="form['feedback_content']" v-if="user_group === '管理员' || (form['employee_feedback_id'] && $check_field('set','feedback_content')) || (!form['employee_feedback_id'] && $check_field('add','feedback_content'))" :disabled="disabledObj['feedback_content_isDisabled']" />
                <!-- 仅查看 -->
      ...
      uni.chooseFile({
        ...
        success: function(res) {
          ...
          const uploadTask = uni.uploadFile({
            url: _self.$fullUrl('/api/employee_feedback/upload?'),
