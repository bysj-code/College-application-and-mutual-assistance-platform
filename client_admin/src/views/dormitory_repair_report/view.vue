	...
	<el-main class="bg edit_wrap">
		<el-form ref="form" :model="form" status-icon label-width="120px" v-if="is_view()">
				...
				<el-form-item label="报修用户" prop="repair_user">
							...
							<!--v-if="user_group === '管理员' || (form['dormitory_repair_report_id'] && $check_field('set','repair_user')) || (!form['dormitory_repair_report_id'] && $check_field('add','repair_user'))" :disabled="disabledObj['repair_user_isDisabled']"></el-input>-->
							<!--<div v-else-if="$check_field('get','repair_user')">{{form['repair_user']}}</div>-->
							<el-select v-if="user_group === '管理员' || (form['dormitory_repair_report_id'] && $check_field('set','repair_user')) || (!form['dormitory_repair_report_id'] && $check_field('add','repair_user'))" id="repair_user" v-model="form['repair_user']" :disabled="disabledObj['repair_user_isDisabled']">
				...
				<el-form-item label="姓名" prop="full_name">
							  ...
							  v-if="user_group === '管理员' || (form['dormitory_repair_report_id'] && $check_field('set','full_name')) || (!form['dormitory_repair_report_id'] && $check_field('add','full_name'))" :disabled="disabledObj['full_name_isDisabled']"></el-input>
					<div v-else-if="$check_field('get','full_name')">{{form['full_name']}}</div>
											</el-form-item>
			</el-col>
								<el-col v-if="user_group === '管理员' || $check_field('get','dormitory_number') || $check_field('add','dormitory_number') || $check_field('set','dormitory_number')" :xs="24" :sm="12" :lg="8" class="el_form_item_warp">
				<el-form-item label="宿舍号" prop="dormitory_number">
												<el-input id="dormitory_number" v-model="form['dormitory_number']" placeholder="请输入宿舍号"
							  v-if="user_group === '管理员' || (form['dormitory_repair_report_id'] && $check_field('set','dormitory_number')) || (!form['dormitory_repair_report_id'] && $check_field('add','dormitory_number'))" :disabled="disabledObj['dormitory_number_isDisabled']"></el-input>
					<div v-else-if="$check_field('get','dormitory_number')">{{form['dormitory_number']}}</div>
											</el-form-item>
			</el-col>
				...
				<el-form-item label="报修日期" prop="repair_date">
								<el-date-picker :disabled="disabledObj['repair_date_isDisabled']" v-if="user_group === '管理员' || (form['dormitory_repair_report_id'] && $check_field('set','repair_date')) || (!form['dormitory_repair_report_id'] && $check_field('add','repair_date'))" id="repair_date"
				...
				<el-form-item label="报修内容" prop="repair_content">
								<el-input type="textarea" id="repair_content" v-model="form['repair_content']" placeholder="请输入报修内容"
						v-if="user_group === '管理员' || (form['dormitory_repair_report_id'] && $check_field('set','repair_content')) || (!form['dormitory_repair_report_id'] && $check_field('add','repair_content'))" :disabled="disabledObj['repair_content_isDisabled']"></el-input>
				...
				<el-form-item label="维修记录" prop="maintenance_records">
							  ...
							  v-if="user_group === '管理员' || (form['dormitory_repair_report_id'] && $check_field('set','maintenance_records')) || (!form['dormitory_repair_report_id'] && $check_field('add','maintenance_records'))" :disabled="disabledObj['maintenance_records_isDisabled']"></el-input>
				...
				<el-form-item label="维修人员" prop="repair_personnel">
													<el-select v-if="user_group === '管理员' || (form['dormitory_repair_report_id'] && $check_field('set','repair_personnel')) || (!form['dormitory_repair_report_id'] && $check_field('add','repair_personnel'))" id="repair_personnel" v-model="form['repair_personnel']" :disabled="disabledObj['repair_personnel_isDisabled']">
