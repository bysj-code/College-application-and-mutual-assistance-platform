			...
			<el-col :xs="24" :sm="12" :lg="8" class="el_form_item_warp">
				<el-form-item label="状态" prop="state">
					<el-select v-model="form.state" placeholder="请选择">
						...
						<el-col v-if="user_group === '管理员' || $check_field('get','job_id') || $check_field('add','job_id') || $check_field('set','job_id')" :xs="24" :sm="12" :lg="8" class="el_form_item_warp">
				<el-form-item label="工号" prop="job_id">
												<el-input id="job_id" v-model="form_sub['job_id']" placeholder="请输入工号"
							  v-if="user_group === '管理员' || (form_sub['working_personnel_id'] && $check_field('set','job_id')) || (!form_sub['working_personnel_id'] && $check_field('add','job_id'))"></el-input>
					<div v-else-if="$check_field('get','job_id')">{{form_sub['job_id']}}</div>
											</el-form-item>
			</el-col>
				...
				<el-form-item label="姓名" prop="full_name">
							  ...
							  v-if="user_group === '管理员' || (form_sub['working_personnel_id'] && $check_field('set','full_name')) || (!form_sub['working_personnel_id'] && $check_field('add','full_name'))"></el-input>
				...
				<el-form-item label="性别" prop="gender">
						...
						v-if="user_group === '管理员' || (form_sub['working_personnel_id'] && $check_field('set','gender')) || (!form_sub['working_personnel_id'] && $check_field('add','gender'))">
